    ...
    <div className="flex flex-col gap-8 max-w-7xl mx-auto animate-in fade-in duration-700">
      <div className="flex flex-col gap-2 border-b border-white/5 pb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white">Solicitações</h1>
        </div>
        <p className="text-[#a1a1aa] text-sm max-w-2xl ml-1">
          Registro de problemas reclamados e histórico de soluções prestadas aos clientes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-[#52525b] text-xs uppercase tracking-widest font-bold">Buscando solicitações...</p>
          </div>
        ) : (
