  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        tabIndex={-1}
        className="relative w-full max-w-lg glass-card-accent p-8 rounded-[40px] shadow-2xl animate-in fade-in zoom-in-95 duration-500 overflow-hidden outline-none"
      >
        <button 
          onClick={onClose}
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <div className="h-1.5 w-12 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-full" />
          </div>
