  ...
  return (
    <div className="bg-[#18181b] p-8 rounded-[32px] border border-white/5 animate-in fade-in slide-in-from-top-4 duration-500 shadow-xl shadow-black/20">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] uppercase tracking-widest text-[#52525b] font-black ml-1">CTO</label>
          <input
            type="text"
            value={formData.cto}
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] uppercase tracking-widest text-[#52525b] font-black ml-1">Lacre</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] uppercase tracking-widest text-[#52525b] font-black ml-1">Portas Livres</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2 md:col-span-2 lg:col-span-3">
          <label className="text-[10px] uppercase tracking-widest text-[#52525b] font-black ml-1">Observações</label>
          <textarea
            rows={3}
